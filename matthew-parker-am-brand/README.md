...
- Photography & Visuals: approved headshot, Nikon AM Synergy collage, and printed-part image are integrated; no fake assets.
...
1. `public/media/matthewparker-headshot.jpeg`: homepage, about page, and contact page.
2. `public/media/nikon-am-synergy-collage.png`: speaking and thought leadership page.
3. `public/media/printed-part.jpeg`: resources and insights page.
